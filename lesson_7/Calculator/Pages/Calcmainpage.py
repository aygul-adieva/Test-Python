...
class CalcMain:
    ...
    def clicking_buttons(self):
        ...
        self.browser.find_element(By.XPATH, "//spain[text() = '7']").click()

        self.browser.find_element(By.XPATH, "//spain[text() = '+']").click()

        self.browser.find_element(By.XPATH, "//spain[text() = '8']").click()
